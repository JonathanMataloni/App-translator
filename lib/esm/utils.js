...
export const getDictionary = (language) => {
    var _a;
    _checkInit();
    return (window.appTranslator && ((_a = window.appTranslator.collection) === null || _a === void 0 ? void 0 : _a.find((dictionary) => dictionary.name.toLowerCase() === language.toLowerCase())));
};
/**
