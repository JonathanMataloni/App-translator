...
exports.getDictionary = function (language) {
    var _a;
    exports._checkInit();
    return (window.appTranslator && ((_a = window.appTranslator.collection) === null || _a === void 0 ? void 0 : _a.find(function (dictionary) { return dictionary.name.toLowerCase() === language.toLowerCase(); })));
};
/**
